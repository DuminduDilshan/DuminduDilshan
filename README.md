...
<div align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=28&duration=3000&pause=1000&color=00D9FF&center=true&vCenter=true&multiline=true&width=800&height=150&lines=Electronics+%26+Telecommunication+Undergraduate;Robotics+%7C+Embedded+Systems+%7C+IoT+Expert;From+Ideas+to+Reality+%F0%9F%9A%80;Building+the+Future%2C+One+Project+at+a+Time!" alt="Typing SVG" />
</div>
...
class DuminduDilshan:
    def __init__(self):
        self.username = "dumindudilshan"
        self.name = "Dumindu Dilshan"
        self.role = "Electronics & Telecom Student"
        self.location = "Sri Lanka 🇱🇰"
        self.passions = ["Robotics", "IoT", "Embedded AI"]
        self.current_focus = [
            "Swarm Robotics 🤖🤖🤖",
            "PID Control Systems",
            "Embedded AI",
...
- 🔧 **Hardware Design** - Circuit design, PCB layouts, sensor integration
- 💻 **Embedded Programming** - Arduino, STM32, ESP32, Raspberry Pi
- 🤖 **Robotics & Automation** - Swarm robotics, autonomous systems
- 🧠 **AI Integration** - Embedded ML, computer vision, decision-making
- 🎨 **3D Design & Printing** - Custom robot parts and prototypes
...
2026_Goals:
  ...
  - Create: "10+ innovative maker projects"
...
<div align="center">
  <img width="100%" src="https://github-readme-stats.vercel.app/api/top-langs/?username=dumindudilshan&layout=compact&theme=radical&hide_border=true&bg_color=0D1117&title_color=00D9FF&text_color=FFFFFF&langs_count=10&hide=jupyter%20notebook" alt="Top Languages" />
...
<dir> 
  <!-- GitHub Stats -->
<p align="center">
 <img width="100%" src="https://github-readme-stats-git-masterrstaa-rickstaa.vercel.app/api?username=dumindudilshan&show_icons=true&theme=radical&hide_border=true" />
...
| 🎓 Education | 🔧 Core Skills | 🚀 Interests |
|:---:|:---:|:---:|
| Electronics & Telecom | Circuit Design | Swarm Intelligence |
| Embedded Systems | PCB Layout | Autonomous Systems |
| Control Systems | Sensor Integration | Computer Vision |
| Signal Processing | Motor Control | Edge AI |
...
- 🦾 **Robotic Arm with Computer Vision** - AI-powered pick & place
- 🚗 **Autonomous Navigation Robot** - SLAM implementation
- 🎯 **Line Following Bot** - Advanced PID control
...
- 📊 **Environmental Monitoring System** - Multi-sensor data logger
- 🔒 **RFID Access Control** - Secure authentication system
- ☀️ **Solar Tracker** - Dual-axis sun-following system
...
- 🎤 **Voice-Controlled Assistant** - NLP for robot commands
- 📈 **Predictive Maintenance** - ML model for equipment health
- 🖼️ **Image Classification** - TinyML on microcontrollers
...
```javascript
const dumindu = {
    code: "More than coffee ☕",
    hobby: "Designing & building robots 🤖",
    inspiration: "Big Hero 6's Microbots 🎬",
    superpower: "Turning ideas into prototypes ⚡",
    dreamProject: "Building a swarm of autonomous rescue robots 🚁"
};
```
...
<div align="center">
  <i>⭐️ From <a href="https://github.com/dumindudilshan">dumindudilshan</a> with 💙 and 🤖</i>
</div>
